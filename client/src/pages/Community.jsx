...
useEffect(()=>{
  ...
  return (
    <div className='flex-1 h-full flex flex-col gap-4 p-6'>
      <h2 className='text-gray-900 dark:text-white'>Creations</h2>
     <div className='bg-white dark:bg-gray-800 h-full w-full rounded-xl overflow-y-scroll flex flex-wrap gap-4 p-3'>
      {creations.map((creation, index)=>(
        <div key={index} className='relative group w-1/3 aspect-square'> 
